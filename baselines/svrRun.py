...
if __name__ == '__main__':
    ...
    FINAL_RESULTS_DIR = os.path.join(RESULTS_FOLDER_DIR, 'svr_results.csv')
    FINAL_ERROR_DIR = os.path.join(RESULTS_FOLDER_DIR, 'svr_errors.csv')
    FINAL_ERROR_SUMMARY_DIR = os.path.join(RESULTS_FOLDER_DIR, 'svr_errors_summary.csv')
