...
%         for s = 1:5 
        for s = 5:9 
            ...
            % Save errors 
            csvwrite([currentDir '/al_exp_seed_results/f' num2str(f) '_s' num2str(s) '_m1_error_' kern_id(kern, :) '.csv'], m1_errors);
            ...
            % Save errors 
            csvwrite([currentDir '/al_exp_seed_results/f' num2str(f) '_s' num2str(s) '_m2_error_' kern_id(kern, :) '.csv'], m2_iter_errors);
            ...
            while length(tr_ind_not_sel{1}) > 50
                ...
                % Call pgp function 
                [so, tst, add_inds] = kernels{kern}(X, Y, Yind, tr_ind_sel, tst_ind, inf_func, tr_ind_not_sel, false, true); 
            ...
            % Save errors 
            csvwrite([currentDir '/al_exp_seed_results/f' num2str(f) '_s' num2str(s) '_m3_error_' kern_id(kern, :) '.csv'], m3_iter_errors);            
            ...
            % Save errors 
            csvwrite([currentDir '/al_exp_seed_results/f' num2str(f) '_s' num2str(s) '_m4_error_' kern_id(kern, :) '.csv'], m4_iter_errors);
