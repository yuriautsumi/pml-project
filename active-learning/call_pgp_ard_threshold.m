function [so, tst, add_inds] = call_pgp_ard_threshold(X, Y, Yind, tr_ind, tst_ind, inf_func, tr_ind_not_sel, error_bool, uncertainty_bool, error_val, uncertainty_val)
% Input: X, Y, indicators, training and testing indices, inference function, not
% selected indices (optional), error sampling boolean, uncertainty sampling
% boolean, error threshold value, uncertainty threshold value 
